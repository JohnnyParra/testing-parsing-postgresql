...
const postQuestion = async(req, res) => {
  ...
  pool.query(`INSERT INTO public.questions (type, subject_id, question, option1, option2, option3, option4, answer)
  VALUES('mcq', 1, '${question}', '${option1}', '${option2}', '${option3}', '${option4}', ${answer})`,(error, results) => {
    if(error){
      throw error
    }
